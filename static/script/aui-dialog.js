    ...
    auiDialog.prototype = {
        ...
        create: function(params,callback) {
            ...
            if(params.input){
                ...
                var msgHtml = '<div class=" aui-text-left aui-font-size-14 aui-dialog-body"><input type="text" placeholder="'+params.text+'"></div>';
            }else{
                var msgHtml = params.msg ? '<div class="aui-dialog-body aui-text-left aui-font-size-14">' + params.msg + '</div>' : '<div class="aui-dialog-body">' + self.params.msg + '</div>';
            }
            ...
            if (buttons && buttons.length > 0) {
                for (var i = 0; i < buttons.length; i++) {
                    ...
                    if(i==0){
                        buttonsHtml += '<div class="aui-dialog-btn asBtn" tapmode button-index="'+i+'">'+buttons[i]+'</div>';
                    }
                }
            }
