...
$(function(){
    createTotalHtmls();
    AjaxToalFuncS();
    // AjaxToalFunc(baseUrl+"wx_yxyx_api/get_activity_rewards"+userActi1);
})
...
function ajaxTab1(){
    ...
    AjaxToalFuncS();
    // AjaxToalFuncs(baseUrl+"wx_yxyx_api/get_activity_rewards"+userIds1,page_count,per_page_count);
}
var disredsult="";
// 循环创建列表
function createTotalHtml(result){
    // alert(result.reward_list.page_info.total_num);
// function createTotalHtml(result,url){
        ...
        $(".container-total-box .btnMore").html("");
        // alert($(".container-total-box .btnMore").html());
    page_count++;
